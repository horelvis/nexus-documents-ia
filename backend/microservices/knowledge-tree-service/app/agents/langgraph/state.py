...
class RAGState(TypedDict, total=False):
    ...
    # Whether SLM Router provided a fast-path answer
    slm_fast_path_used: bool

    # SLM Router answer (if fast-path was used)
    slm_answer: Optional[str]
...
class ExecutionConfig:
    ...
    enable_slm_fast_path: bool = True
