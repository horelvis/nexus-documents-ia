...
.. deprecated:: 2.0.0
    This module is deprecated in favor of the SLM Router (services/slm_router).
    The SLM Router provides unified TOON-based query planning that replaces
    this hybrid classification approach. This module will be removed in v3.0.0.

    Migration guide:
    - Instead of HybridKnowledgeRouter, use:
