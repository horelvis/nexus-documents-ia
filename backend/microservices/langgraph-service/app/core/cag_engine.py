...
class ContextExpansionStrategy:
    ...
    def __init__(self, vector_service: VectorService, llm: BaseLLM, embeddings: Embeddings):
...
class CAGEngine:
    ...
    def __init__(
        ...
        self.context_expander = ContextExpansionStrategy(vector_service, llm, embeddings)
