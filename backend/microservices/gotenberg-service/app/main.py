...
@app.post("/thumbnails/generate-from-pdf", response_model=ThumbnailResponse)
...
@app.post("/thumbnails/generate-from-image", response_model=ImageThumbnailResponse)
...
@app.get("/formats/supported", response_model=SupportedFormatsResponse)
