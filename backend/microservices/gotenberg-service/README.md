...
El microservicio **`gotenberg-service`** (puerto 8005) está basado en la imagen oficial `gotenberg/gotenberg:edge` e incluye:
...
- **Base**: gotenberg/gotenberg:edge (imagen oficial)
