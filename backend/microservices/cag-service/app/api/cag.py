...
async def generate_embeddings(
    ...
    try:
        ...
        return {
            ...
            "model": cag_service.embeddings.model
        }
...
async def process_query_stream(
    ...
    async def event_stream() -> AsyncGenerator[str, None]:
        try:
            ...
            yield f"data: {json.dumps({'type': 'progress', 'content': 'Initializing CAG engine...', 'progress': 10})}\n\n"
...
async def analyze_document_stream(
    ...
    async def event_stream() -> AsyncGenerator[str, None]:
        try:
            ...
            # Send initial progress
            yield f"data: {json.dumps({'type': 'progress', 'content': 'Starting document analysis...', 'progress': 5})}\n\n"
