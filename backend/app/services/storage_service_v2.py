...
class StorageServiceV2:
    ...
    Mantiene la misma interfaz que el StorageService original para compatibilidad.
    """
    ...
    def __init__(self, tenant_id: str, user_id: Optional[str] = None):
        ...
        self.client = StorageClient(tenant_id, user_id)
        
        # Para compatibilidad con código existente
        self.bucket_name = f"storage-service-{tenant_id}"
