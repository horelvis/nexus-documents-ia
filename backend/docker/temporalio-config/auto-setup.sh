...
register_default_namespace() {
    ...
    local namespace_args=("--namespace" "${DEFAULT_NAMESPACE}")
    if ! temporal operator namespace describe "${namespace_args[@]}"; then
        echo "Default namespace ${DEFAULT_NAMESPACE} not found. Creating..."
        temporal operator namespace create "${namespace_args[@]}" --retention "${DEFAULT_NAMESPACE_RETENTION}" --description "Default namespace for Temporal Server."
...
add_custom_search_attributes() {
    local namespace_args=("--namespace" "${DEFAULT_NAMESPACE}")
    until temporal operator search-attribute list "${namespace_args[@]}"; do
...
# @@@SNIPSTART add-custom-search-attributes-for-testing-command
    temporal operator search-attribute create "${namespace_args[@]}" \
