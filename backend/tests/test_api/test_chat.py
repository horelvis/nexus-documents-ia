...
def test_chat_with_documents(client, test_documents, normal_user_token_headers, mock_embedding_service, mock_emma_service):
...
def test_suggest_tags(client, normal_user_token_headers, mock_emma_service):
...
def test_extract_metadata(client, normal_user_token_headers, mock_emma_service):
