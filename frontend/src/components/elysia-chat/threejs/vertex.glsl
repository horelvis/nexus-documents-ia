...
// Simplified perlin noise functions (since we don't have the glslify partials)
float perlin3d(vec3 p) {
    return sin(p.x * 6.28318 + sin(p.y * 6.28318 + sin(p.z * 6.28318))) * 0.5 + 0.5;
}

float perlin4d(vec4 p) {
    return perlin3d(p.xyz + p.w);
}
