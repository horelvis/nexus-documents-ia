...
export const OIDC_CONFIG = {
  // KeyCloak server URL
  issuer: process.env.NEXT_PUBLIC_OIDC_ISSUER || 'http://nexus-docs360.es:8080/realms/nexus',

  // Client credentials
  clientId: process.env.NEXT_PUBLIC_OIDC_CLIENT_ID || 'emma-app',
  clientSecret: process.env.NEXT_PUBLIC_OIDC_CLIENT_SECRET || 'emma-secret-key-change-in-production',
  ...
  get redirectUri() {
    ...
    return 'http://nexus-docs360.es:3001/auth/callback'
  },
  ...
  get postLogoutRedirectUri() {
    ...
    return 'http://nexus-docs360.es:3001/auth/sign-in'
  },
