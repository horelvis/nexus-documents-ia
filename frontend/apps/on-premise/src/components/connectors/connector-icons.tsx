...
function DatabaseIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <ellipse cx="12" cy="5" rx="8" ry="3" fill="#4F46E5"/>
      <path d="M4 5V19C4 20.66 7.58 22 12 22C16.42 22 20 20.66 20 19V5" stroke="#4F46E5" strokeWidth="2" fill="none"/>
      <ellipse cx="12" cy="19" rx="8" ry="3" fill="#4F46E5" fillOpacity="0.3"/>
      <path d="M4 12C4 13.66 7.58 15 12 15C16.42 15 20 13.66 20 12" stroke="#4F46E5" strokeWidth="2"/>
      <path d="M4 8.5C4 10.16 7.58 11.5 12 11.5C16.42 11.5 20 10.16 20 8.5" stroke="#4F46E5" strokeWidth="1.5" strokeOpacity="0.6"/>
      <path d="M4 15.5C4 17.16 7.58 18.5 12 18.5C16.42 18.5 20 17.16 20 15.5" stroke="#4F46E5" strokeWidth="1.5" strokeOpacity="0.6"/>
    </svg>
  )
}
